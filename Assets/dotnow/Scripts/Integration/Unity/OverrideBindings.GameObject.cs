...
namespace UnityEngine
{
    public static partial class OverrideBindings
    {
        ...
        public static object AddComponentOverride(dotnow.AppDomain domain, MethodInfo overrideMethod, object instance, object[] args, Type[] genericArguments)
        {
            return AddComponentOverride(domain, overrideMethod, instance, new object[] { genericArguments[0] });
        }
