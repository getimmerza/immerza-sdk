...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineXRInteractionToolkitLocomotionXRBodyGroundPositionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.XR.Interaction.Toolkit.Locomotion.XRBodyGroundPosition);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UnityEngine.XR.Interaction.Toolkit.Locomotion.XRBodyGroundPosition();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.XR.Interaction.Toolkit.Locomotion.XRBodyGroundPosition constructor!");
        ...
        static int _m_Apply(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.XR.Interaction.Toolkit.Locomotion.XRBodyGroundPosition gen_to_be_invoked = (UnityEngine.XR.Interaction.Toolkit.Locomotion.XRBodyGroundPosition)translator.FastGetCSObj(L, 1);
