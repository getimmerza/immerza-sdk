...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineXRInteractionToolkitInputsCompositesVector3FallbackCompositeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.XR.Interaction.Toolkit.Inputs.Composites.Vector3FallbackComposite);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UnityEngine.XR.Interaction.Toolkit.Inputs.Composites.Vector3FallbackComposite();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.XR.Interaction.Toolkit.Inputs.Composites.Vector3FallbackComposite constructor!");
        ...
        static int _m_ReadValue(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.XR.Interaction.Toolkit.Inputs.Composites.Vector3FallbackComposite gen_to_be_invoked = (UnityEngine.XR.Interaction.Toolkit.Inputs.Composites.Vector3FallbackComposite)translator.FastGetCSObj(L, 1);
