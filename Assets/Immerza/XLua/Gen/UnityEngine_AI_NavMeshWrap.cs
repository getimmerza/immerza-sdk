...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAINavMeshWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 28, 3, 3);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetAreaNames", _m_GetAreaNames_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "IsLinkActive", _m_IsLinkActive_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "SetLinkActive", _m_SetLinkActive_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "IsLinkOccupied", _m_IsLinkOccupied_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "IsLinkValid", _m_IsLinkValid_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetLinkOwner", _m_GetLinkOwner_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "SetLinkOwner", _m_SetLinkOwner_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetAreaNames_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = UnityEngine.AI.NavMesh.GetAreaNames(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_IsLinkActive_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    UnityEngine.AI.NavMeshLinkInstance _handle;translator.Get(L, 1, out _handle);
                        ...
                        var gen_ret = UnityEngine.AI.NavMesh.IsLinkActive( _handle );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetLinkActive_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.AI.NavMesh.SetLinkActive( _handle, _value );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_IsLinkOccupied_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    UnityEngine.AI.NavMeshLinkInstance _handle;translator.Get(L, 1, out _handle);
                        ...
                        var gen_ret = UnityEngine.AI.NavMesh.IsLinkOccupied( _handle );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_IsLinkValid_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    UnityEngine.AI.NavMeshLinkInstance _handle;translator.Get(L, 1, out _handle);
                        ...
                        var gen_ret = UnityEngine.AI.NavMesh.IsLinkValid( _handle );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetLinkOwner_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    UnityEngine.AI.NavMeshLinkInstance _handle;translator.Get(L, 1, out _handle);
                        ...
                        var gen_ret = UnityEngine.AI.NavMesh.GetLinkOwner( _handle );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetLinkOwner_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.AI.NavMesh.SetLinkOwner( _handle, _owner );
