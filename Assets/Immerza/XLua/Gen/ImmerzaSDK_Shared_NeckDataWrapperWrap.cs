...
namespace XLua.CSObjectWrap
{
    ...
    public class ImmerzaSDKSharedNeckDataWrapperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ImmerzaSDK.Shared.NeckDataWrapper);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ImmerzaSDK.Shared.NeckDataWrapper();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ImmerzaSDK.Shared.NeckDataWrapper constructor!");
        ...
        static int _m_SetStatus(RealStatePtr L)
        {
		    try {
                ...
                ImmerzaSDK.Shared.NeckDataWrapper gen_to_be_invoked = (ImmerzaSDK.Shared.NeckDataWrapper)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_subject(RealStatePtr L)
        {
		    try {
                ...
                ImmerzaSDK.Shared.NeckDataWrapper gen_to_be_invoked = (ImmerzaSDK.Shared.NeckDataWrapper)translator.FastGetCSObj(L, 1);
                translator.PushAny(L, gen_to_be_invoked.subject);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_device(RealStatePtr L)
        {
		    try {
                ...
                ImmerzaSDK.Shared.NeckDataWrapper gen_to_be_invoked = (ImmerzaSDK.Shared.NeckDataWrapper)translator.FastGetCSObj(L, 1);
                translator.PushAny(L, gen_to_be_invoked.device);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_subject(RealStatePtr L)
        {
		    try {
                ...
                ImmerzaSDK.Shared.NeckDataWrapper gen_to_be_invoked = (ImmerzaSDK.Shared.NeckDataWrapper)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.subject = translator.GetObject(L, 2, typeof(object));
        ...
        static int _s_set_device(RealStatePtr L)
        {
		    try {
                ...
                ImmerzaSDK.Shared.NeckDataWrapper gen_to_be_invoked = (ImmerzaSDK.Shared.NeckDataWrapper)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.device = translator.GetObject(L, 2, typeof(object));
        ...
        static int _s_set_components(RealStatePtr L)
        {
		    try {
                ...
                ImmerzaSDK.Shared.NeckDataWrapper gen_to_be_invoked = (ImmerzaSDK.Shared.NeckDataWrapper)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.components = (System.Collections.Generic.List<object>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<object>));
