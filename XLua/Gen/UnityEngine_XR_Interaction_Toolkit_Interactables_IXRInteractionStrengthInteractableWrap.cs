...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineXRInteractionToolkitInteractablesIXRInteractionStrengthInteractableWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.XR.Interaction.Toolkit.Interactables.IXRInteractionStrengthInteractable);
        ...
        {
            return LuaAPI.luaL_error(L, "UnityEngine.XR.Interaction.Toolkit.Interactables.IXRInteractionStrengthInteractable does not have a constructor!");
        }
        ...
        static int _m_GetInteractionStrength(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.XR.Interaction.Toolkit.Interactables.IXRInteractionStrengthInteractable gen_to_be_invoked = (UnityEngine.XR.Interaction.Toolkit.Interactables.IXRInteractionStrengthInteractable)translator.FastGetCSObj(L, 1);
