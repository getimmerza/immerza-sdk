...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineXRInteractionToolkitInputsHapticsHapticImpulseCommandChannelWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.XR.Interaction.Toolkit.Inputs.Haptics.HapticImpulseCommandChannel);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UnityEngine.XR.Interaction.Toolkit.Inputs.Haptics.HapticImpulseCommandChannel();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.XR.Interaction.Toolkit.Inputs.Haptics.HapticImpulseCommandChannel constructor!");
        ...
        static int _m_SendHapticImpulse(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.XR.Interaction.Toolkit.Inputs.Haptics.HapticImpulseCommandChannel gen_to_be_invoked = (UnityEngine.XR.Interaction.Toolkit.Inputs.Haptics.HapticImpulseCommandChannel)translator.FastGetCSObj(L, 1);
