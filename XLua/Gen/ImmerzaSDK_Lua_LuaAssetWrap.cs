...
namespace XLua.CSObjectWrap
{
    ...
    public class ImmerzaSDKLuaLuaAssetWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ImmerzaSDK.Lua.LuaAsset);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new ImmerzaSDK.Lua.LuaAsset();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ImmerzaSDK.Lua.LuaAsset constructor!");
        ...
        static int _g_get_content(RealStatePtr L)
        {
		    try {
                ...
                ImmerzaSDK.Lua.LuaAsset gen_to_be_invoked = (ImmerzaSDK.Lua.LuaAsset)translator.FastGetCSObj(L, 1);
