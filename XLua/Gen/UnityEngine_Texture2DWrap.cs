...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTexture2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 19, 14, 3);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 7 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && translator.Assignable<UnityEngine.Experimental.Rendering.DefaultFormat>(L, 4) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5) && translator.Assignable<UnityEngine.Experimental.Rendering.TextureCreationFlags>(L, 6) && translator.Assignable<UnityEngine.MipmapLimitDescriptor>(L, 7))
				{
					int _width = LuaAPI.xlua_tointeger(L, 2);
					int _height = LuaAPI.xlua_tointeger(L, 3);
					UnityEngine.Experimental.Rendering.DefaultFormat _format;translator.Get(L, 4, out _format);
					int _mipCount = LuaAPI.xlua_tointeger(L, 5);
					UnityEngine.Experimental.Rendering.TextureCreationFlags _flags;translator.Get(L, 6, out _flags);
					UnityEngine.MipmapLimitDescriptor _mipmapLimitDescriptor;translator.Get(L, 7, out _mipmapLimitDescriptor);
					
					var gen_ret = new UnityEngine.Texture2D(_width, _height, _format, _mipCount, _flags, _mipmapLimitDescriptor);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 7 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && translator.Assignable<UnityEngine.Experimental.Rendering.GraphicsFormat>(L, 4) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5) && translator.Assignable<UnityEngine.Experimental.Rendering.TextureCreationFlags>(L, 6) && translator.Assignable<UnityEngine.MipmapLimitDescriptor>(L, 7))
				{
					int _width = LuaAPI.xlua_tointeger(L, 2);
					int _height = LuaAPI.xlua_tointeger(L, 3);
					UnityEngine.Experimental.Rendering.GraphicsFormat _format;translator.Get(L, 4, out _format);
				...
				if(LuaAPI.lua_gettop(L) == 8 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && translator.Assignable<UnityEngine.TextureFormat>(L, 4) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 6) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 7) && translator.Assignable<UnityEngine.MipmapLimitDescriptor>(L, 8))
				{
					int _width = LuaAPI.xlua_tointeger(L, 2);
					int _height = LuaAPI.xlua_tointeger(L, 3);
					UnityEngine.TextureFormat _textureFormat;translator.Get(L, 4, out _textureFormat);
					...
					var gen_ret = new UnityEngine.Texture2D(_width, _height, _textureFormat, _mipCount, _linear, _createUninitialized, _mipmapLimitDescriptor);
					translator.Push(L, gen_ret);
        ...
        static int _m_CopyPixels(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 5&& translator.Assignable<UnityEngine.Texture>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    UnityEngine.Texture _src = (UnityEngine.Texture)translator.GetObject(L, 2, typeof(UnityEngine.Texture));
                    int _srcElement = LuaAPI.xlua_tointeger(L, 3);
                    int _srcMip = LuaAPI.xlua_tointeger(L, 4);
                    int _dstMip = LuaAPI.xlua_tointeger(L, 5);
                    
                    gen_to_be_invoked.CopyPixels( _src, _srcElement, _srcMip, _dstMip );
                ...
                if(gen_param_count == 11&& translator.Assignable<UnityEngine.Texture>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 7)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 8)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 9)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 10)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 11)) 
                {
                    ...
                    int _dstMip = LuaAPI.xlua_tointeger(L, 9);
                    int _dstX = LuaAPI.xlua_tointeger(L, 10);
                    int _dstY = LuaAPI.xlua_tointeger(L, 11);
                    
                    gen_to_be_invoked.CopyPixels( _src, _srcElement, _srcMip, _srcX, _srcY, _srcWidth, _srcHeight, _dstMip, _dstX, _dstY );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Texture2D.CopyPixels!");
