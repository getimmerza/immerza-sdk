...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineXRInteractionToolkitActivateEventArgsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.XR.Interaction.Toolkit.ActivateEventArgs);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UnityEngine.XR.Interaction.Toolkit.ActivateEventArgs();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.XR.Interaction.Toolkit.ActivateEventArgs constructor!");
        ...
        static int _g_get_interactorObject(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.XR.Interaction.Toolkit.ActivateEventArgs gen_to_be_invoked = (UnityEngine.XR.Interaction.Toolkit.ActivateEventArgs)translator.FastGetCSObj(L, 1);
