...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineXRInteractionToolkitInputsCompositesIntegerFallbackCompositeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityEngine.XR.Interaction.Toolkit.Inputs.Composites.IntegerFallbackComposite);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UnityEngine.XR.Interaction.Toolkit.Inputs.Composites.IntegerFallbackComposite();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.XR.Interaction.Toolkit.Inputs.Composites.IntegerFallbackComposite constructor!");
        ...
        static int _m_ReadValue(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.XR.Interaction.Toolkit.Inputs.Composites.IntegerFallbackComposite gen_to_be_invoked = (UnityEngine.XR.Interaction.Toolkit.Inputs.Composites.IntegerFallbackComposite)translator.FastGetCSObj(L, 1);
